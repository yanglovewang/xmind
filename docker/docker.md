...
docker镜像(Images)：软件打包好的镜像；放在docker仓库中；dockerhub这个网站容纳容器的站点
...
docker search mysql  去docker仓库里面找mysql
...
9、启动一个做了端口映射的tomcat，然后去阿里云开放映射的端口8888容器端口
